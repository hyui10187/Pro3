...
public class TalkManager : MonoBehaviour {
    ...
    private void GenerateData() {
        ...
        talkData.Add(7600, new string[] { "잘 만들어진 눈사람이다.", "써니가 만들었을까?" });
        ...
        // 퀘스트 90: 써니에게 사탕주기
        talkData.Add(120000 + 100, new string[] { "어머 이 사탕 나에게 주는거야?", "언니 정말 고마워!", "고마우니까 선물로 이 목걸이를 줄께!" });
        
        // 퀘스트 100: 대니의 부탁 들어주기
        talkData.Add(140000 + 110, new string[] { "저기 있잖아", "요리를 위해 향신료가 필요한데 말이야", "카리나 옆에 있는 항아리에 담긴 정향을 가져다 줄 수 있을까?", "아 절대 내가 가져오기 귀찮아서 부탁하는건 아니야!" });

        // 퀘스트 110: 대니의 부탁 들어주기
        talkData.Add(140000 + 120, new string[] { "뭐? 정향이 담긴 항아리가 깨져있었다고?", "사람들이 다치지 않도록 파편을 치웠다니 잘했군", "정향은 내가 직접 창고에서 가져와야겠어" });
    }
